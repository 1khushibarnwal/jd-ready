...
const ResumeDraftSchema = new mongoose.Schema(
  {
    ...
    // Short capability bullets (e.g. "Builds REST APIs with Node.js and Express"),
    // either typed by the user or generated by the "Generate from a job description"
    // flow. Kept separate from `summary` so it can render as its own PDF section.
